    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100">
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="space-y-8 prose dark:prose-invert max-w-none text-zinc-700 dark:text-zinc-300">
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-4 border-b border-zinc-100 dark:border-zinc-800 pb-2">1. Information We Collect</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-4 border-b border-zinc-100 dark:border-zinc-800 pb-2">2. How We Use Your Information</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-4 border-b border-zinc-100 dark:border-zinc-800 pb-2">3. Data Storage and Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-4 border-b border-zinc-100 dark:border-zinc-800 pb-2">4. Third-Party Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-4 border-b border-zinc-100 dark:border-zinc-800 pb-2">6. Changes to This Policy</h2>
            <p>
          ...
          <section>
            ...
            <p>
              If you have any questions about this Privacy Policy, please contact us at <a href="mailto:contact@invoice-quickly.com" className="text-blue-600 hover:underline">contact@invoice-quickly.com</a>.
            </p>
          </section>
        </div>
      </main>
