...
export const metadata: Metadata = {
  title: "Privacy",
  description: "InvoiceQuickly privacy information. Your data is secure with our free invoice generator.",
      ...
      <header className="border-b border-zinc-200 dark:border-zinc-800 bg-[#f6f6f6] dark:bg-zinc-950/80 backdrop-blur-md sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 font-bold text-xl tracking-tight">
            <img src="/logo.png" alt="InvoiceQuickly — Free Online Invoice Generator" className="h-8 w-8 object-contain" width={32} height={32} />
