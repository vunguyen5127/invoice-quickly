    ...
    <div className="container mx-auto px-4 sm:px-8 py-8 max-w-7xl animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div className="flex items-center gap-4">
          <div className="p-2 w-10 h-10 bg-zinc-100 dark:bg-zinc-800 rounded-[5px]"></div>
      ...
      <div className="w-full h-[800px] bg-white/60 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800 rounded-[5px] shadow-sm flex flex-col p-8">
