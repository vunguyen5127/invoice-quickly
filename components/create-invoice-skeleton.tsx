...
export function CreateInvoiceSkeleton() {
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-zinc-950 animate-pulse">
      {/* Header Skeleton */}
      <header className="sticky top-0 z-50 w-full border-b border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl shadow-sm h-14">
            ...
            <div className="bg-white dark:bg-zinc-900/50 rounded-[5px] shadow-sm border border-zinc-200 dark:border-zinc-800 p-4 sm:p-6 lg:p-8 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <div className="h-4 w-24 bg-zinc-100 dark:bg-zinc-800/60 rounded-md"></div>
                  <div className="h-10 w-full bg-zinc-100 dark:bg-zinc-800/40 rounded-xl"></div>
                </div>
                <div className="space-y-2">
                  <div className="h-4 w-24 bg-zinc-100 dark:bg-zinc-800/60 rounded-md"></div>
                  <div className="h-10 w-full bg-zinc-100 dark:bg-zinc-800/40 rounded-xl"></div>
              ...
              <div className="space-y-2">
                ...
                <div className="h-24 w-full bg-zinc-100 dark:bg-zinc-800/40 rounded-xl"></div>
              </div>
              <div className="space-y-4 pt-4 border-t border-zinc-100 dark:border-zinc-800">
                <div className="h-6 w-32 bg-zinc-200 dark:bg-zinc-800 rounded-lg"></div>
                {[1, 2].map(i => (
                  <div key={i} className="flex gap-4">
                    <div className="h-10 flex-1 bg-zinc-100 dark:bg-zinc-800/40 rounded-xl"></div>
                    <div className="h-10 w-20 bg-zinc-100 dark:bg-zinc-800/40 rounded-xl"></div>
                    <div className="h-10 w-24 bg-zinc-100 dark:bg-zinc-800/40 rounded-xl"></div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="aspect-[1/1.41] w-full bg-white dark:bg-zinc-900/50 rounded-[5px] shadow-lg border border-zinc-200 dark:border-zinc-800 p-8 space-y-6">
               ...
               <div className="grid grid-cols-2 gap-8 pt-8">
                  <div className="space-y-3">
                     <div className="h-4 w-20 bg-zinc-100 dark:bg-zinc-800/60 rounded-md"></div>
                     <div className="h-20 w-full bg-zinc-100 dark:bg-zinc-800/40 rounded-xl"></div>
                  </div>
                  <div className="space-y-3">
                     <div className="h-4 w-20 bg-zinc-100 dark:bg-zinc-800/60 rounded-md"></div>
                     <div className="h-20 w-full bg-zinc-100 dark:bg-zinc-800/40 rounded-xl"></div>
               ...
               <div className="mt-12 space-y-4">
                  <div className="h-8 w-full bg-zinc-100 dark:bg-zinc-800/40 rounded-lg"></div>
                  <div className="h-8 w-full bg-zinc-100 dark:bg-zinc-800/40 rounded-lg"></div>
                  <div className="h-8 w-full bg-zinc-100 dark:bg-zinc-800/40 rounded-lg"></div>
               </div>
            </div>
