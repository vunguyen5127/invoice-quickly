  ...
  return (
    <div className="container mx-auto px-4 sm:px-8 py-8 max-w-2xl">
      ...
      <div className="mb-8 flex items-center gap-4 animate-pulse">
        <div className="p-2 rounded-full bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-800 w-9 h-9"></div>
        <div className="space-y-2">
          <div className="h-8 w-40 bg-zinc-200 dark:bg-zinc-800 rounded-[5px]"></div>
          <div className="h-4 w-56 bg-zinc-100 dark:bg-zinc-800/60 rounded-[5px]"></div>
        </div>
      </div>
      ...
      <div className={sectionClass}>
        ...
        <div className={itemClass}>
          ...
          <div className="h-8 w-24 bg-zinc-100 dark:bg-zinc-800 rounded"></div>
        </div>
        <div className={itemClass}>
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-lg bg-zinc-100 dark:bg-zinc-800 w-8 h-8"></div>
