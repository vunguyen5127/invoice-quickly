...
import { createCompany } from "@/utils/supabase/dashboard-actions";
...
export function CreateCompanyModal({ isOpen, onClose, onSuccess }: CreateCompanyModalProps) {
  ...
  const [defaultNotes, setDefaultNotes] = useState("Thank you for your business! We appreciate your trust and look forward to working with you again.");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isPhoneValid) {
      setTab("company"); // Switch to company tab so user can see the error
      return;
    }
