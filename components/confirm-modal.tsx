  ...
  return (
    <>
      ...
      <div className="fixed left-[50%] top-[50%] z-50 translate-x-[-50%] translate-y-[-50%] w-full max-w-md p-4 animate-in fade-in zoom-in-95 duration-200">
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[5px] shadow-xl overflow-hidden flex flex-col">
          ...
          <div className="p-6 pt-4 flex flex-col-reverse sm:flex-row gap-3 justify-end items-center bg-zinc-50 dark:bg-zinc-800/20 border-t border-zinc-100 dark:border-zinc-800">
            <button
              ...
              className="w-full sm:w-auto px-4 py-2 rounded-lg font-medium text-sm text-zinc-700 dark:text-zinc-300 hover:bg-zinc-200 dark:hover:bg-zinc-800 transition-colors disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              onClick={onConfirm}
              disabled={isProcessing}
              className="w-full sm:w-auto px-4 py-2 rounded-lg font-medium text-sm text-destructive-foreground bg-destructive hover:opacity-90 transition-all shadow-sm disabled:opacity-75 flex items-center justify-center min-w-[100px]"
            >
