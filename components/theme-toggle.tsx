...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="hidden sm:inline-flex items-center justify-center rounded-full p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors bg-white border border-zinc-200 shadow-sm dark:bg-zinc-900 dark:border-zinc-800"
